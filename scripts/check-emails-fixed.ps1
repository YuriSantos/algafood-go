...
Write-Host "`n2. Verificar container de email (MailHog):" -ForegroundColor White
...
Write-Host "`n--- Métodos para ver emails enviados ---" -ForegroundColor Green
Write-Host "1. 📊 ESTATÍSTICAS (já mostrado acima)" -ForegroundColor White
Write-Host "2. 📋 LOGS EM TEMPO REAL:" -ForegroundColor White
Write-Host "   docker logs algafood-localstack-1 -f" -ForegroundColor Gray
Write-Host "3. 📧 INTERFACE WEB:" -ForegroundColor White
Write-Host "   .\scripts\email-viewer.html" -ForegroundColor Gray
Write-Host "4. 🔍 BUSCA ESPECÍFICA:" -ForegroundColor White
Write-Host "   docker logs algafood-localstack-1 | findstr 'admin@algafood.com.br'" -ForegroundColor Gray
